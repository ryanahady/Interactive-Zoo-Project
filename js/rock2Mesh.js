        ...
        loader.load('models/Rock_6.ply', function (rock_geometry) {
            ...
            rockSca.makeScale(250 / rockSize.length(), 250 / rockSize.length(), 250 / rockSize.length());
            ...
            scene.add(rock1);
            rock1.position.x += -220;
            rock1.position.z += -220;
            ...
            scene.add(rock2);
            rock2.position.x += 220;
            rock2.position.z += 220;
